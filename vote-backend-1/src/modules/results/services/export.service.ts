...
export class ExportService {
     ...
     * Export to PDF
     */
    private async exportToPDF(results: PositionResult[], options: ExportOptionsDto): Promise<Buffer> {
     ...
     * Export to JSON
     */
    private async exportToJSON(results: PositionResult[], options: ExportOptionsDto): Promise<Buffer> {
        const exportData: {
            metadata: {
                exportedAt: Date;
                exportedBy: string;
     ...
     * Export to CSV
     */
    private async exportToCSV(results: PositionResult[], options: ExportOptionsDto): Promise<Buffer> {
